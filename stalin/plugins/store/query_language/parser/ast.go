...
import (
	...
	"stalin/plugins/store/query_language/lexical"
)
...
// NOT LIKE
func (n *NodeNotLike) Assertion(lvalue string, rvalue string) bool {
	if len(lvalue) == 40 {
		return lvalue[0:len(rvalue)] == rvalue
	}
	return lvalue == rvalue
...
func (n *NodeNotLike) Operator() uint8 {
	return lexical.T_LIKE
}

func (n *NodeNotLike) SetLeftValue(e NodeExpr) {
	n.leftValue = e
}

func (n *NodeNotLike) SetRightValue(e NodeExpr) {
	n.rightValue = e
}

func (n *NodeNotLike) RightValue() NodeExpr {
	return n.rightValue
}

func (n *NodeNotLike) LeftValue() NodeExpr {
	return n.leftValue
}
